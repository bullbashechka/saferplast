...
- [x] **FLOW-03**: После блока подбора решения посетитель видит блок "как проходит работа"
- [x] **FLOW-04**: После блока процесса посетитель видит блок "наши работы" с CTA "получить консультацию"
- [x] **FLOW-05**: После блока работ посетитель видит блок отзывов клиентов (5-6 карточек) в формате слайдера со стрелками по краям
- [x] **FLOW-06**: После блока отзывов посетитель видит FAQ
- [x] **FLOW-07**: После FAQ посетитель видит нижнюю форму заявки
...
| FLOW-01 | Фаза 2 | Завершено |
| FLOW-02 | Фаза 2 | Завершено |
| FLOW-03 | Фаза 2 | Завершено |
| FLOW-04 | Фаза 2 | Завершено |
| FLOW-05 | Фаза 2 | Завершено |
| FLOW-06 | Фаза 2 | Завершено |
| FLOW-07 | Фаза 2 | Завершено |

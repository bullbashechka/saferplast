  ...
  return (
    ...
    >
      <div className="mx-auto w-full max-w-[300px] md:max-w-[1201px]">
        ...
        <div className="hidden md:grid md:grid-cols-2 md:gap-5 xl:grid-cols-[387px_387px_387px] xl:gap-x-5 xl:gap-y-0">
          <div className="flex flex-col gap-8 xl:gap-9">
            <div className="xl:h-[87px]">
              <h2 className="font-display text-[2rem] font-normal leading-[1] text-[#004B62] lg:text-[2.25rem] xl:text-[44px]">
                {title}
              </h2>
              <p className="mt-4 max-w-[20rem] text-[1rem] font-normal leading-[1.2] text-[#000000] xl:w-[279px]">
                {subtitle}
              </p>
            </div>
          ...
          <div className="flex flex-col gap-5 md:col-span-2 xl:col-span-1">
            ...
            <a
              className="inline-flex h-[74px] w-full items-center justify-center whitespace-nowrap rounded-[15px] border border-[#004B62] px-[2.75rem] text-center text-[1.125rem] font-medium leading-[1] text-[#004B62] transition-colors hover:bg-[#004B62] hover:text-white xl:px-[66px] xl:text-[20px]"
              href={ctaHref}
            >
              {ctaLabel}
            </a>

    ...
    >
      <div className="mx-auto w-full max-w-content lg:max-w-[1201px]">
        <div className="grid gap-10 lg:grid-cols-[263px_minmax(12rem,14rem)_minmax(0,1fr)] lg:gap-[9rem]">
          ...
          <nav aria-label="Навигация в подвале" className="lg:justify-self-center">
            <ul className="grid gap-4">
              {navigationLinks.map((link) => (
                <li key={link.href}>
                  <a
                    className="font-body text-[1rem] font-normal leading-[1] tracking-[0] text-[#242424] transition-colors hover:text-[#004B62]"
                    href={link.href}
                  >
                    {link.label}
                  </a>

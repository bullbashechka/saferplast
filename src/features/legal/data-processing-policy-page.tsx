    ...
    <main className="min-h-screen bg-[rgba(250,254,255,1)] px-4 pb-12 pt-8 text-[#242424] md:px-8 md:pb-16 md:pt-10">
      ...
      <div className="mx-auto w-full max-w-[900px]">
        ...
        <p className="mt-4 text-[14px] leading-[1.45] md:text-[15px]">
          ...
          полученных через форму на сайте {companyDetails.website}.
        </p>
        ...
        <section className="mt-8 space-y-6 text-[14px] leading-[1.5] md:text-[15px]">
          ...
          <div>
            ...
            <p className="mt-2">
              Цель обработки — принять заявку и связаться с пользователем по его
              запросу.
            </p>
          </div>
          ...
          <div>
            ...
            <p className="mt-2">
              ...
              персональных данных, выраженного при отправке формы.
            </p>
          </div>

          <div>
            <h2 className="font-semibold text-[#004B62]">
              5. Порядок обработки и передача
            </h2>
            <p className="mt-2">
              Заявки обрабатываются оператором и передаются только в
              Telegram-бота оператора, который используется для обратной связи с
              клиентом.
            </p>
          </div>
          ...
          <div>
            ...
            <p className="mt-2">
              При отсутствии заключенного договора данные заявки хранятся не
              более 90 дней с даты обращения.
            </p>
          </div>
          ...
          <div>
            ...
            <p className="mt-2">
              Удаление заявок старше 90 дней выполняется вручную уполномоченным
              сотрудником не реже одного раза в неделю.
            </p>
          </div>
          ...
          <div>
            <h2 className="font-semibold text-[#004B62]">
              9. Обращения по данным
            </h2>
            <p className="mt-2">
              По вопросам обработки персональных данных и для отзыва согласия
              можно обратиться по телефону: {companyDetails.phone}.
            </p>
          </div>
        </section>

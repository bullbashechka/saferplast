...
export function PublicOfferPage() {
  const seo = legalSeoByPath["/public-offer"];
        ...
        <section className="mt-8 space-y-6 text-[14px] leading-[1.5] md:text-[15px]">
          ...
          <div>
            ...
            <p className="mt-2">
              ...
              сторонами дополнительно. 4.3. Обязательства по оплате считаются исполненными с момента поступления
          ...
          <div>
            ...
            <p className="mt-2">
              ...
              действующей политикой конфиденциальности и политикой обработки персональных данных, размещенными на
              сайте.
            </p>
          </div>

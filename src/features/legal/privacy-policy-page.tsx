    ...
    <main className="min-h-screen bg-[rgba(250,254,255,1)] px-4 pb-12 pt-8 text-[#242424] md:px-8 md:pb-16 md:pt-10">
      <div className="mx-auto w-full max-w-[900px]">
        ...
        <p className="mt-4 text-[14px] leading-[1.45] md:text-[15px]">
          Эта Политика объясняет, какие персональные данные мы получаем через
          форму на сайте {companyDetails.website}, как используем их и как
          защищаем.
        </p>
        ...
        <section className="mt-8 space-y-6 text-[14px] leading-[1.5] md:text-[15px]">
          <div>
            ...
            <p className="mt-2">
              Оператор: {companyDetails.companyName}, БИН/ИИН:{" "}
              {companyDetails.binOrIin}, адрес: {companyDetails.address},
          ...
          <div>
            ...
            <p className="mt-2">
              Мы обрабатываем данные только для одной цели: принять вашу заявку
              и связаться с вами по вашему запросу.
            </p>
          </div>
          ...
          <div>
            ...
            <p className="mt-2">
              Основание обработки — ваше согласие, которое вы даете при отправке
              формы и установке обязательных отметок согласия.
            </p>
          </div>

          <div>
            <h2 className="font-semibold text-[#004B62]">
              5. Куда передаются данные из формы
            </h2>
            <p className="mt-2">
              Заявка с сайта передается только в Telegram-бота оператора,
              который используется как рабочий канал для оперативной связи с
              клиентом.
            </p>
          </div>
          ...
          <div>
            ...
            <p className="mt-2">
              Если договор не заключен, данные заявки хранятся не дольше 90 дней
              с даты отправки. После истечения срока данные подлежат удалению.
            </p>
          </div>
          ...
          <div>
            ...
            <p className="mt-2">
              Уполномоченный сотрудник проводит ручную очистку рабочих сообщений
              и заявок старше 90 дней не реже одного раза в неделю.
            </p>
          </div>
          ...
          <div>
            <h2 className="font-semibold text-[#004B62]">
              9. Контакты и отзыв согласия
            </h2>
            <p className="mt-2">
              По вопросам обработки данных и для отзыва согласия вы можете
              обратиться по телефону: {companyDetails.phone}.
            </p>
          </div>
        </section>
